...
DoaPar.nEvents = 1;                         % Number of events
...
DoaPar.Fsignal = 10000;                           % Signal frequency
                            ...
                            for fsample = DoaPar.Fsample
                                for fsignal = DoaPar.Fsignal
                                    ...
                                    for events = DoaPar.nEvents
                                        %% --- Calling Function --- 
                                        T = calcule_T_original(SNR,theta,array,algorithms,events,sources,peak_factor,deviation,fsample,fsignal,DoaPar.Magnitude);
